...
-(NSArray *)applicationShortcutItems {
    ...
    //item.icon = (SBSApplicationShortcutIcon*)[UIApplicationShortcutIcon iconWithType:UIApplicationShortcutIconTypeCloud];
...
-(id)initWithTitle:(id)title subtitle:(id)arg2 image:(id)image badgeView:(id)arg4 handler:(id)arg5 {
    if ([title isEqualToString:@"Free Storage"]) {
        image = [[UIImage imageWithContentsOfFile:@"/var/mobile/Library/Application Support/storage3D/floppy.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    }
